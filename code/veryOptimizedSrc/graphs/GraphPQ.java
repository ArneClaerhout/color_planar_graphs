...
public class GraphPQ extends Graph {
    ...
    private PriorityQueue<Vertex> vertices = new PriorityQueue<>(
            Comparator.comparingInt(Vertex::getAmountOfAvailableColors));
    ...
    private boolean optimizedAlgorithm(Coloring coloring, boolean open, boolean proper, boolean um,
        ...
        // We have to recheck whether we ended on the case where the last vertex is not
        // real
        ...
        for (int i = colors; i != 0; i &= i - 1) {
            ...
            // We create the changed ArrayList for this vertex here, as we can use this
            // later on
            ...
            if (updateNeighbours(v.getOpenNeighbourhood(), color, coloring, open, proper, um, false, changed)) {
                // We enter this if statement when we find an early prune, found by
                // updateNeighbours
                continue;
            }
     ...
     * @param addColor
     *                      Whether the color should get added back to the
     *                      neighbours.
     *                      This only does it for the neighbours given in the
     *                      ArrayList changed.
     * @param changed
     ...
     *                      This will contain the old vertices that were removed
     *                      from verticesIndexed.
    ...
    private boolean updateNeighbours(long neighbourhood, int color, Coloring coloring, boolean open, boolean proper,
        ...
        if (addColor) {
            ...
            for (Vertex changedNeighbour : changed) {
                ...
                // We also readd the changedNeighbours back as they could have been removed
                // already.
            }
